...
def freeze_baseline(csv_path, source_url=None):
    ...
    manifest = {
        ...
        'source': {
            ...
            'note': 'Production deployment must use real UCI Online Retail II dataset' if source_url is None else None
        },
        'schema': {
...
def verify_baseline(csv_path, manifest_path=MANIFEST_PATH):
    ...
    if actual_hash == expected_hash:
        ...
        return False, "BASELINE TAMPERING DETECTED"
...
def main():
    ...
    print("="*60)
    is_valid, message = verify_baseline(csv_path)
